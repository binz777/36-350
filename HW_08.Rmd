...
```{r linewidth=80}
readLines("https://raw.githubusercontent.com/binz777/36-350/main/README.md")
```
...
```{r linewidth=80}
library(devtools)
source_url("https://raw.githubusercontent.com/binz777/36-350/main/dark_and_stormy.R")
```
...
```{r linewidth=80}
source_url("https://raw.githubusercontent.com/binz777/36-350-Fork/main/check_mark.R")
```
---
